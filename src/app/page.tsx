...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/table-setting_74190-3618.jpg",
          alt: "Diner 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/side-view-couple-having-lunch_23-2150598339.jpg",
          alt: "Diner 2",
        },
        {
      ...
      bulletPoints={[
        {
          ...
          description: "Partnerships with local, ethical farmers.",
        },
        {
          title: "Culinary Vision",
          description: "Innovative techniques paired with heritage recipes.",
        },
        {
          title: "Unrivaled Ambiance",
          description: "Designed for intimacy, connection, and joy.",
        },
      ]}
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "€22",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-detox-drink-arrangement_23-2148683596.jpg",
        },
        {
          id: "5",
          name: "Roasted Quail",
      ...
      metrics={[
        {
          ...
          description: "Decades spent perfecting the art of dining.",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-men-celebrating-with-wine_23-2149152936.jpg",
        },
        {
          id: "2",
          value: "40+",
          title: "Local Farmers",
          description: "Direct partnerships for freshest quality.",
          imageSrc: "http://img.b2bpic.net/free-photo/male-chef-seasoning-salad_23-2148763187.jpg",
        },
        {
          id: "3",
          value: "12",
          title: "Industry Awards",
          description: "Recognized by global critics.",
      ...
      team={[
        {
          ...
          name: "Marcella V.",
          role: "Executive Chef",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-young-male-cook-white-cook-suit-white-head-cap-posing_140725-15534.jpg",
        },
        {
          id: "t2",
          name: "Julian S.",
        ...
        },
        {
          ...
          name: "Sophie L.",
          role: "Pastry Chef",
          imageSrc: "http://img.b2bpic.net/free-photo/baked-ham-food-photography-recipe-idea_53876-25020.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we encourage early bookings to secure your preferred dining time.",
        },
        {
          id: "f2",
          title: "Do you cater for dietary restrictions?",
          content: "Our kitchen is happy to accommodate all allergies and dietary preferences with advance notice.",
        },
        {
          id: "f3",
          title: "Is the dress code formal?",
          content: "We maintain a 'smart elegant' dress code to suit our atmosphere.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      description="Sign up for seasonal menu updates and reservation notifications."
